...
interface ErrorCircleIconProps extends React.SVGProps<SVGSVGElement> {
  $width?: number;
  $height?: number;
  $className?: string;
  $fill?: string;
...
export const ErrorCircleIcon = ({
  ...
  >
    <path
      d="M15.9905 18.0902C15.4465 18.0902 15.0028 17.6544 14.9932 17.1105L14.8872 11.126C14.8762 10.5074 15.3747 10 15.9934 10C16.6126 10 17.1112 10.5081 17.0996 11.1271L16.9877 17.1115C16.9776 17.655 16.5341 18.0902 15.9905 18.0902Z"
      fill="currentColor"
    />{' '}
    <path
